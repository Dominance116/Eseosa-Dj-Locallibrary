# Generated by Django 5.0 on 2023-12-13 20:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_of_birth', models.DateField(blank=True, null=True, verbose_name='Died')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. History, Biography, Autography, Romance, etc.)', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
